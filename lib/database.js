/**
 * SQLite Database for ModelLab
 * Real persistence that survives restarts
 */
...
const createDataset = db.prepare(`
  INSERT INTO datasets (id, name, description, file_path, file_type, file_count, total_size, schema, checksum, version, tags, metadata, created_at, updated_at)
  VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
`);
