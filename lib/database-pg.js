...
// Base directory for file storage (consistent with SQLite adapter)
...
// Generate SHA-256 checksum for file (for compatibility with SQLite adapter)
...
// Generate unique ID (for compatibility with SQLite adapter)
function generateId() {
